import moviesReducer from '../src/store/reducers/movies/moviesSlice'

it("movies default reducer", () => {
  const action = {
    type: "",
  };
  const initialState = {
...
it("movies reducer initial state with data", () => {
  const action = {
    type: "",
  };
  const initialState ={
...
it("movies reducer initial state empty", () => {
  const action = {
    type: "",
  };
  const initialState = {
...
it("movies reducer return payload", () => {
  const action = {
    type: "movies/fetch",
    payload: 
      {
